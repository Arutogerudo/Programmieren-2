 ...
 */
public class WoodenWall extends CollidingGameObject implements ShiftableGameObject {
    private static final String WOODEN_WALL = "LLOOOOOO\nLLOOLLOO\nLLLLOOOO\nLLOOOOLL\nLLLLOOOO\nLLOOOOOO\nLLLLLLOO\nLLOOOOOO";
    private static final double SIZE1 = 3.2;
    private static final int AMOUNT_WALLS = 19;
