 ...
 */
public class WallRocketPadDown extends CollidingGameObject implements ShiftableGameObject, ActivatableGameObject {
     ...
     */
    public WallRocketPadDown(GameView gameView, GamePlayManager gamePlayManager) {
    ...
    public void addToCanvas() {
        for (int orderplace = 0; orderplace < 52; orderplace++) {
            gameView.addImageToCanvas("wallrocketpaddown.png", position.getX() + orderplace * singleWidth, position.getY(), size, rotation);
        }
    }
